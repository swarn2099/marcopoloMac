     ...
     if(index === 0){
       firebase.firestore().collection('approvedEvents').get().then((snap) => {
             ...
             events = Object.keys(itemsFree)
               ...
               .filter(e => e.category === 'Free' && moment().isBefore(moment(e.date, 'MMMM D, YYYY'), 'day'));
               this.setState(() => ({
                 refreshing: false,
                 events,
                 index
     ...
     if(index === 1){
       firebase.firestore().collection('approvedEvents').get().then((snap) => {
         ...
         events = Object.keys(itemsFood  || {})
           ...
           .filter(e => e.category === 'Food' && moment().isBefore(moment(e.date, 'MMMM D, YYYY'), 'day')  );
           this.setState(() => ({
             refreshing: false,
             events,
             index,
     ...
     if(index === 2){
       firebase.firestore().collection('approvedEvents').get().then((snap) => {
         ...
         events = Object.keys(itemsMusic || {})
           ...
           .filter(e => e.category === 'Music' && moment().isBefore(moment(e.date, 'MMMM D, YYYY'), 'day')  );
           this.setState(() => ({
             refreshing: false,
             events,
           }));
     ...
     if(index === 3){
       firebase.firestore().collection('approvedEvents').get().then((snap) => {
         ...
         events = Object.keys(itemsParties || {})
           ...
           .filter(e => e.category === 'Parties' && moment().isBefore(moment(e.date, 'MMMM D, YYYY'), 'day')  );
           this.setState(() => ({
             refreshing: false,
             events,
           }));
     ...
     if(index === 4){
       firebase.firestore().collection('approvedEvents').get().then((snap) => {
         ...
         events = Object.keys(itemsClub || {})
           ...
           .filter(e => e.category === 'Club' && moment().isBefore(moment(e.date, 'MMMM D, YYYY'), 'day')  );
           console.log(events);
           this.setState(() => ({
             refreshing: false,
             events,
     ...
     if(index === 5){
       firebase.firestore().collection('approvedEvents').get().then((snap) => {
         ...
         events = Object.keys(itemsAll || {})
           ...
           .filter(e =>moment().isBefore(moment(e.date, 'MMMM D, YYYY'), 'day')  );
           this.setState(() => ({
             refreshing: false,
             events,
           }));
