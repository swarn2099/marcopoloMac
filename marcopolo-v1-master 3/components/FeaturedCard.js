...
import {addApprovedLike} from './helper';
const buttonProps = {
  size: 20,
  color: 'white',
  padding: 5
...
const FeaturedCard=props=>{
  let {image,type,name,time,date,initial,page,tagline,interested,...rest}=props;
  ...
  return (
    ...
    <View style={{flexDirection:'row',justifyContent:'space-between',}}>
      ...
      <View style={{flexDirection:'row'}}>
        ...
        <Button rounded style={{padding:25}}onPress={()=>addApprovedLike(initial)}><Feather name="thumbs-up"{...buttonProps}/></Button>
        </View>
        </View>
      </View>
    </Card>
