<component name="InspectionProjectProfileManager">
  <profile version="1.0" is_locked="true">
    ...
    <inspection_tool class="AccessModifierPresentedInspection" enabled="false" level="ERROR" enabled_by_default="false" />
    <inspection_tool class="AdditionOperationOnArraysInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    <inspection_tool class="AlterInForeachInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    ...
    <inspection_tool class="AnonymousGroup" enabled="false" level="WARNING" enabled_by_default="false" />
    <inspection_tool class="ArrayCastingEquivalentInspection" enabled="false" level="WEAK WARNING" enabled_by_default="false" />
    <inspection_tool class="ArrayTypeOfParameterByDefaultValueInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    ...
    <inspection_tool class="CallableInLoopTerminationConditionInspection" enabled="false" level="ERROR" enabled_by_default="false" />
    ...
    <inspection_tool class="ComposerJsonSchema" enabled="false" level="ERROR" enabled_by_default="false" />
    ...
    <inspection_tool class="CssUnknownProperty" enabled="true" level="WARNING" enabled_by_default="true">
      ...
      <option name="myCustomPropertiesList">
        <value>
          <list size="2">
            <item index="0" class="java.lang.String" itemvalue="_appearance" />
            <item index="1" class="java.lang.String" itemvalue="backface-visiblity" />
          </list>
        </value>
      </option>
    </inspection_tool>
    ...
    <inspection_tool class="DeclareUseStrictTypesInspection" enabled="false" level="WEAK WARNING" enabled_by_default="false" />
    <inspection_tool class="DefaultNotLastCaseInSwitchJS" enabled="false" level="WARNING" enabled_by_default="false" />
    <inspection_tool class="DisconnectedForeachInstructionInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    ...
    <inspection_tool class="ES6ConvertVarToLetConst" enabled="true" level="WARNING" enabled_by_default="true" />
    ...
    <inspection_tool class="EmptyAlternationBranch" enabled="true" level="WARNING" enabled_by_default="true" />
    ...
    <inspection_tool class="EscapedMetaCharacter" enabled="true" level="INFORMATION" enabled_by_default="true" />
    ...
    <inspection_tool class="FilePath" enabled="true" level="WARNING" enabled_by_default="true" />
    ...
    <inspection_tool class="GenericObjectTypeUsageInspection" enabled="false" level="WEAK WARNING" enabled_by_default="false" />
      ...
      <option name="myValues">
        <value>
          <list size="2">
            ...
            <item index="1" class="java.lang.String" itemvalue="ontouchstart" />
          </list>
        </value>
      </option>
      ...
      <option name="myValues">
        <value>
          <list size="8">
            ...
            <item index="6" class="java.lang.String" itemvalue="trix-editor" />
            <item index="7" class="java.lang.String" itemvalue="trix-toolbar" />
          </list>
        </value>
      </option>
      <option name="myCustomValuesEnabled" value="true" />
    ...
    <inspection_tool class="ImplicitMagicMethodCallInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    ...
    <inspection_tool class="IsEmptyFunctionUsageInspection" enabled="true" level="WARNING" enabled_by_default="true">
    ...
    <inspection_tool class="MessDetectorValidationInspection" enabled="false" level="WARNING" enabled_by_default="false">
      <option name="CODESIZE" value="true" />
    </inspection_tool>
    <inspection_tool class="Misconfiguration" enabled="true" level="WEAK WARNING" enabled_by_default="true" />
    <inspection_tool class="MkdirRaceConditionInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    <inspection_tool class="MoreThanThreeArgumentsInspection" enabled="true" level="WARNING" enabled_by_default="true">
      <option name="limit" value="4" />
    </inspection_tool>
    <inspection_tool class="MultiAssignmentUsageInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    ...
    <inspection_tool class="NotInstalledPackage" enabled="true" level="WEAK WARNING" enabled_by_default="true" />
    <inspection_tool class="NotOptimalIfConditionsInspection" enabled="true" level="WEAK WARNING" enabled_by_default="true" />
    ...
    <inspection_tool class="OctalEscape" enabled="true" level="INFORMATION" enabled_by_default="true" />
    ...
    <inspection_tool class="PackageVersion" enabled="true" level="WEAK WARNING" enabled_by_default="true" />
    <inspection_tool class="ParameterByRefWithDefaultInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    ...
    <inspection_tool class="PhpFunctionNamingConventionInspection" enabled="true" level="WEAK WARNING" enabled_by_default="true">
      <option name="m_minLength" value="1" />
      <option name="m_maxLength" value="36" />
    </inspection_tool>
    ...
    <inspection_tool class="PhpInternalEntityUsedInspection" enabled="false" level="INFO" enabled_by_default="false" />
    ...
    <inspection_tool class="PhpPropertyNamingConventionInspection" enabled="false" level="WARNING" enabled_by_default="false">
      <option name="m_maxLength" value="22" />
    </inspection_tool>
    ...
    <inspection_tool class="PhpTraditionalSyntaxArrayLiteralInspection" enabled="true" level="INFO" enabled_by_default="true" />
    ...
    <inspection_tool class="PhpUndefinedFieldInspection" enabled="true" level="WEAK WARNING" enabled_by_default="true" />
    ...
    <inspection_tool class="PhpUnusedLocalVariableInspection" enabled="true" level="WARNING" enabled_by_default="true">
      <option name="ENABLE_IN_FILE_SCOPE" value="true" />
    </inspection_tool>
    ...
    <inspection_tool class="PropertyCanBeStaticInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    ...
    <inspection_tool class="RandomApiMigrationInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    ...
    <inspection_tool class="SSBasedInspection" enabled="true" level="WEAK WARNING" enabled_by_default="true">
      <searchConfiguration name="Avoid short variable names" text="$shortVariableName$ = " recursive="true" caseInsensitive="true" type="PHP">
        <constraint name="__context__" within="" contains="" />
        <constraint name="shortVariableName" regexp="\$((?!id)[a-zA-Z0-9]{1,2})" minCount="0" maxCount="0" target="true" within="" contains="" />
      </searchConfiguration>
      <searchConfiguration name="$_POST direct access" text="$_POST[$Index$]" recursive="true" caseInsensitive="true" type="PHP">
        <constraint name="Index" regexp="^[&quot;'][a-zA-Z0-9_-]+[&quot;']$" within="" contains="" />
      </searchConfiguration>
      <searchConfiguration name="Using compact with a dynamic named variable" text="compact($VAR$)" recursive="true" caseInsensitive="true" type="PHP">
        <constraint name="VAR" regexp="\$.*" within="" contains="" />
      </searchConfiguration>
      <searchConfiguration name="$_GET direct access" text="$_GET[$Index$]" recursive="true" caseInsensitive="true" type="PHP">
        <constraint name="Index" regexp="^[&quot;'][a-zA-Z0-9_-]+[&quot;']$" within="" contains="" />
      </searchConfiguration>
      <searchConfiguration name="Globals in classes" text="global $VarName$;" recursive="true" caseInsensitive="true" type="PHP">
        <constraint name="VarName" regexp="\$[a-zA-Z_0-9]+" within="" contains="" />
        <constraint name="__context__" target="true" within="" contains="" />
      </searchConfiguration>
      <searchConfiguration name="Use HTTP class instead of header()." text="header(" recursive="true" caseInsensitive="true" type="PHP" />
    </inspection_tool>
    ...
    <inspection_tool class="Schema" enabled="true" level="ERROR" enabled_by_default="true" />
    ...
    <inspection_tool class="SlowArrayOperationsInLoopInspection" enabled="false" level="WEAK WARNING" enabled_by_default="false" />
    ...
    <inspection_tool class="StrStrUsedAsStrPosInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    <inspection_tool class="StringLiteralBreaksHTMLJS" enabled="false" level="WARNING" enabled_by_default="false" />
    <inspection_tool class="Stylelint" enabled="true" level="WEAK WARNING" enabled_by_default="true" />
    <inspection_tool class="SubStrUsedAsArrayAccessInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    <inspection_tool class="SummerTimeUnsafeTimeManipulationInspection" enabled="false" level="WEAK WARNING" enabled_by_default="false" />
    ...
    <inspection_tool class="TypeUnsafeArraySearchInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    <inspection_tool class="TypeUnsafeComparisonInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    <inspection_tool class="TypesCastingWithFunctionsInspection" enabled="true" level="WEAK WARNING" enabled_by_default="true" />
    <inspection_tool class="TypescriptExplicitMemberType" enabled="true" level="INFORMATION" enabled_by_default="true" />
    <inspection_tool class="UnSafeIsSetOverArrayInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    ...
    <inspection_tool class="UntrustedInclusionInspection" enabled="false" level="ERROR" enabled_by_default="false" />
    ...
    <inspection_tool class="UsingInclusionOnceReturnValueInspection" enabled="true" level="WARNING" enabled_by_default="true" />
    <inspection_tool class="VariableFunctionsUsageInspection" enabled="false" level="WARNING" enabled_by_default="false" />
    ...
    <inspection_tool class="XmlDefaultAttributeValue" enabled="false" level="WEAK WARNING" enabled_by_default="false" />
